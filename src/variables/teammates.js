const TEAMMATES_DATA = [
  ...
  },
  {
    id: '5_Ivan',
    name: 'Иван Канищев',
    text: `Главный дизайнер нашей команды, все страницы были нарисованы Иваном. Имея трудную работу и задачу нарисовать нарисовать все страницы, успевал помогать команде с написанием кода. Написал мини-игру, сделал графическое отображения статистики.`,
    style: {
      height: '204px',
      width: '204px',
  ...
  },
  {
    ...
    text: `Быстро влился в новую технологию разработки и начал делать свои компоненты.
      На протяжении всей работы почти не возникало вопросов по его работе. Сделал мини-игру, страницу с мини-играми,

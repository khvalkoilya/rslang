const TEAMMATES_DATA = [
  ...
  },
  {
    id: '5_Ivan',
    name: 'Иван Канищев',
    text: `Главный дизайнер нашей команды, все страницы были нарисованы Иваном. Имея трудную работу и задачу нарисовать все страницы, успевал помогать команде с написанием кода. Написал мини-игру, сделал графическое отображения статистики.`,
    style: {
      height: '204px',
      width: '204px',
